...
ImageInfo* inv_pixel1bpp_c(ImageInfo* pImg, unsigned int x, unsigned int y)
{
...
ImageInfo* inv_pixel4bpp_c(ImageInfo* pImg, unsigned int x, unsigned int y)
{
